  ...
  return (
    <div style={{ backgroundImage: "url('images/register.jpg')" }} className='h-screen pt-20'>
      ...
      <div className="max-w-xl relative mx-auto p-6 bg-white rounded-2xl shadow-lg">
        ...
        <div className="border-dotted border-2 border-black text-center ring-offset-4 mb-4 mx-3 ring-4 ring-[#094c73] text-base text-red-500 bg-white font-medium px-1 rounded-md">
